...
var index_config_default = {
  ...
  xiaomi: {
    url: "https://xiaomiai.site"
  },
  huban: {
    url: "http://103.45.162.207:20720"
  },
  ouge: {
  ...
  danmu: {
    urls: [
      ...
      { address: "https://danmu.2019279.xyz/87654321", name: "默认3" },
  ...
  live: {
    url: [
      { name: "豆豆之家 ", url: "https://tv01.5868788.xyz/ddys/live/zb.txt", index: "true" }
    ]
  },
  vcm3u8: {
    maoyan: [{
      ...
      categories: ["电影片", "连续剧", "综艺片", "动漫片", "海外剧", "纪录片", "短剧", "体育"],
      search: true
    }],
    iqiyizyapi: [{
      name: "爱奇艺",
    ...
    shigys: [{
      name: "时光影视",
      url: "https://www.shigys.com/api.php/provide/vod",
      categories: ["电影片", "连续剧", "综艺片", "动漫片", "海外剧", "纪录片", "短剧", "体育"],
      search: true
    }],
    wsyzy: [{
  ...
  appys: {
    ...
    jumeng: [{
      name: "剧梦屋",
      url: "https://www.jumeng.click/api.php/app/",
      // categories: ['国产剧', '香港剧', '韩国剧', '欧美剧', '台湾剧', '日本剧', '海外剧', '泰国剧', '短剧', '动作片', '喜剧片', '爱情片', '科幻片', '恐怖片', '剧情片', '战争片', '动漫片', '大陆综艺', '港台综艺', '日韩综艺', '欧美综艺', '国产动漫', '日韩动漫', '欧美动漫', '港台动漫', '海外动漫', '记录片'],                        
      search: true
      //搜索开关 true开 false关
    }],
    nivod: [{
      name: "泥视频",
      url: "https://www.nivod.vip/api.php/app/",
      // categories: ['国产剧', '香港剧', '韩国剧', '欧美剧', '台湾剧', '日本剧', '海外剧', '泰国剧', '短剧', '动作片', '喜剧片', '爱情片', '科幻片', '恐怖片', '剧情片', '战争片', '动漫片', '大陆综艺', '港台综艺', '日韩综艺', '欧美综艺', '国产动漫', '日韩动漫', '欧美动漫', '港台动漫', '海外动漫', '记录片'],                        
      search: true
      //搜索开关 true开 false关
    }]
  ...
  color: [
    ...
    {
      light: {
        bg: "https://tv01.5868788.xyz/ddys/api/mobile.php",
        bgMask: "0x50ffffff",
        primary: "0xff666014",
        onPrimary: "0xffffffff",
    ...
    {
      light: {
        bg: "https://tv01.5868788.xyz/ddys/api/pc.php",
        bgMask: "0x50ffffff",
        primary: "0xFF2B6C00",
        onPrimary: "0xFFFFFFFF",
